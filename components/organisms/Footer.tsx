      ...
      <div className="mx-auto max-w-[1440px] px-4 md:px-8 py-12 md:py-16 lg:py-20">
              ...
              {connectLinks.map((link) => {
                ...
                return (
                  <li key={link.href}>
                    <a
                      href={link.href}
                      className="font-inter text-base text-neutral-300 hover:text-terracotta-400 transition-colors duration-[300ms] ease-[cubic-bezier(0.33,1,0.68,1)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-terracotta-500 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-900 rounded-sm inline-flex items-center gap-2"
        ...
        <div className="flex justify-center items-center text-sm text-neutral-400">
          <p className="font-inter">
            © 2025 Logan Bell. Built with Next.js + Tailwind
          </p>
        </div>
      </div>
    </footer>
